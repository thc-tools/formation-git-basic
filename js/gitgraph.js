...
(function () {
    ...
    function Commit(options) {
      ...
      this.message = options.message || this.template.commit.message.defaultMessage;
     ...
     * @param {string} [options.commit.message.defaultMessage] - Commit message color
    ...
    function Template(options) {
      ...
      this.commit.message = {};
      this.commit.message.defaultMessage = options.commit.message.defaultMessage || "He doesn't like George Michael! Boooo!";
